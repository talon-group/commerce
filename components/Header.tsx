...
const Header: FunctionComponent = () => {
    ...
    const checkout = async () => {
        ...
        if (b.session && b.session.url) {
            window.location.href = b.session.url;
        } else {
            console.error('Checkout session creation failed:', b.message);
        }
    };
                                                    ...
                                                    <li key={price.id} className="py-6 flex">
                                                        ...
                                                        <div className="ml-4 flex-1 flex flex-col">
                                                            ...
                                                            <div className="flex-1 flex items-end justify-between text-sm">
                                                                <div className="flex">
                                                                    <button onClick={() => removeFromCart(price.id)} type="button" className="font-medium text-indigo-600 hover:text-indigo-500">
                                                                        Remove
                                                                    </button>
                                                                </div>
                                                            </div>
